...
def ParseReviews(asin):
    ...
    amazon_url = 'https://www.amazon.com/VivoBook-i7-8550U-GeForce-Backlit-Windows/product-reviews/' \
                 'B07661CYPD/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews&pageNumber=1'
